...
const TOUR_STEPS = [
  ...
  },
  {
    id: 'toolbar',
    title: 'Tool Rail',
    text: 'Use the icon rail to access tools — pages, annotations, drawing, shapes, forms, and more.',
    target: '.mb-icon-rail',
    position: 'right',
  },
  {
    ...
    text: 'Click the draw or shape icons on the rail to access annotation tools.',
    target: '[data-panel="draw"]',
    position: 'right',
  },
  {
    id: 'pages',
    title: 'Page Thumbnails',
    text: 'Click the pages icon to see thumbnails. Right-click for options like rotate, delete, or reorder.',
    target: '[data-panel="pages"]',
    position: 'right',
  },
  {
    id: 'export',
